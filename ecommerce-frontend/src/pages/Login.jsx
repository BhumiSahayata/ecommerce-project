      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        >
          <div className="space-y-4">
            ...
            >
              {loading ? (
                <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full" style={{ animation: 'spin 0.8s linear infinite' }} />Signing in...</>
              ) : "Sign In"}
            </button>
          </div>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link to="/register" className="font-semibold transition-colors" style={{ color: 'var(--brand)' }}>
              Create one free
            </Link>
          </p>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 text-xs" style={{ background: 'var(--bg-surface)', color: 'var(--text-muted)' }}>
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              style={{ border: '1px solid var(--border-default)', color: 'var(--text-secondary)', background: 'var(--bg-raised)' }}
